...
The prepared source for the next release is `RELEASE-NOTES-0.17.4.md`. Keep the file publish-ready; the workflow treats draft markers, missing sections and mismatched versions as release blockers.
