...
The production container test additionally verifies mounted release replacement, required persistence guards, the supported split Unraid mounts, live RCON checkpoint creation and non-destructive checkpoint restore.
